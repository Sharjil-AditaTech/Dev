    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_kind', models.CharField(choices=[('1', 'Tier-1'), ('2', 'Tier-2'), ('3', 'Tier-3'), ('4', 'Other')], max_length=1)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('section', models.CharField(choices=[('-1', 'others'), ('0', 'profile'), ('1', 'setting'), ('2', 'upload'), ('3', 'reports')], default='0', max_length=10)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('user_kind', models.CharField(max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('group', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='accounts_engine.group')),
